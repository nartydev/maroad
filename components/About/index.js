  ...
  <div>
    <div className="about__top">
        ...
        <div className="text__top">
            <p>Pour faire bouger les choses <br></br><span className="block-orange">il faut une équipe engagée</span></p>
        </div>
    </div>
        ...
        <div className="about__goals">
            ...
            <div className="about__goals__info">
              ...
              <div className="goals__info__card">
                <h3>Créer des <br></br><span className="color-orange">liens sociaux</span></h3>
              ...
              <div className="goals__info__card">
                <h3>Réchauffer <br></br><span className="color-orange">des coeurs</span></h3>
              ...
              <div className="goals__info__card">
                <h3>Faire vivre une <br></br><span className="color-orange">expérience unique</span></h3>
